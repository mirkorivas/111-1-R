...
# survey
survey = list()
survey$questions[[1]] <- "Are you happy with our campus? Choose a number from 5(very happy), 4(happy), 3(satisfy), 2( unhappy), to 1(very unhappy)."
...
single_response$questions[[1]] <- survey$options[[1]][[4]]
...
reponses <- list(reponse1, reponse2, reponse3)
reponses

#responses = list()
#responses[[1]]$questions[[1]] <- survey$options[[1]][[4]]
#responses[[1]]$questions[[2]] <- c(2,4)
#responses[[2]]$questions[[1]] <- survey$options[[1]][[3]]
#responses[[2]]$questions[[2]] <- NA
#responses[[3]]$questions[[1]] <- survey$options[[1]][[5]]
#responses[[3]]$questions[[2]] <- c(1:3)
#responses
```
...
```{r ans14}
# responses
reponses <- reponses[c(1,3)]
reponses[[1]]$questions[[1]] <- survey$options[[1]][[3]]
reponses[[2]]$questions[[1]] <- survey$options[[1]][[3]]
reponses
```
